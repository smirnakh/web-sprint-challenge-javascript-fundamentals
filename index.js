...
//it can modify the same variable without passing that variable as an argument
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    const filterPoputation = zooAnimals.filter((zooAnimal) => {
    return zooAnimal.population < 5;
    });
    return filterPoputation;
  }
  ...
  */
  ...
  function USApop(zooAnimals){
    const totalPopulation = zooAnimals.reduce(
